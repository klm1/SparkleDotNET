...
namespace SparkleDotNET
{
    ...
    public class KNBinding : KNKVOObserver {
        ...
        public void ObserveValueForKeyPathOfObject(string keyPath, object obj, Dictionary<string, object> change, object context) {
            ...
            if (keyPath.Equals(SourceKeyPath) && obj == Source && (string)context == kKNBindingInternalObservationContext) {
            ...
            } else if (keyPath.Equals(TargetKeyPath) & obj == Target && (string)context == kKNBindingInternalObservationContext) {
